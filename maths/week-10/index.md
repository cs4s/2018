...
- [Recap of Exploring Mathematical Relationships Part 1]({{ site.drive_url | append: '13IQAhAbrf39NPuWRau4TMYoTjspp-reL' }}){:target="_blank"} (PDF Presentation)
...
| Outcome                                                                                                                                           | How the Outcome is addressed                                                                                                                                                                                                                                                                                           |
|:--------------------------------------------------------------------------------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **MA3-1WM:** describes and represents mathematical situations in a variety of ways using mathematical terminology and some conventions            | In this session’s activities, you will have the opportunity to describe and represent a variety of mathematical situations. For example, in the *Altering Rectangles* activity you will use mathematical conventions, in conjunction with Coding commands, to move the Sprite in the Scratch project around the Stage. |
...
| Outcome                                                                                                                                                        | How the Outcome is addressed                                                                                                                                                                                                                                                              |
|:---------------------------------------------------------------------------------------------------------------------------------------------------------------|:------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **MA3-9MG:** selects and uses the appropriate unit and device to measure lengths and distances, calculates perimeters, and converts between units of length    | In this session's activities, you will calculate side lengths of shapes drawn in the Scratch projects. For example, in the *Exploring Mathematical Similarity* activity you will add blocks that will calculate the ratios of different rectangles that you draw on the Stage in Scratch. |
...
|:----------------------------------------------|:------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Estimating and calculating with whole numbers | In this session’s activities, you will calculate with whole numbers when moving Sprites around the Stage in Scratch. For example, in the *Sequence of Squares* activity you will use whole numbers when you create scripts to move the Beetle to different positions on the Stage.        |
| Using spatial reasoning                       | In this session’s activities, you will use spatial reasoning when moving Sprites around the Stage in Scratch. For example, in the *Exploring Mathematical Similarity* activity, you will move the Beetle Sprite to different positions on the Stage.                                                                                                                                                                                              |
| Using measurement                             | In this session's activities, you will calculate side lengths of shapes drawn in the Scratch projects. For example, in the *Exploring Mathematical Similarity* activity you will add blocks that will calculate the ratios of different rectangles that you draw on the Stage in Scratch. |
{: .table .table-striped .table-bordered}
...
|:-------------------------|:---------------------------------------------------------------|
| Creating with ICT        | In this session, you will draw different patterns in Scratch. |
{: .table .table-striped .table-bordered}
